...
function NavIcon({ name, size = 18 }: { name: string; size?: number }) {
  ...
  switch (name) {
    ...
    case 'craig': return <svg {...props}><path d="M9.5 2A5.5 5.5 0 0 0 4 7.5V16a4 4 0 0 0 4 4h8a4 4 0 0 0 4-4V7.5A5.5 5.5 0 0 0 14.5 2z" /><circle cx="9" cy="10" r="1.5" fill="currentColor" stroke="none" /><circle cx="15" cy="10" r="1.5" fill="currentColor" stroke="none" /><path d="M9 15c1.5 1.5 4.5 1.5 6 0" /></svg>;
    default: return null;
  }
}
